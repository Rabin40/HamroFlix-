...
echo "<h2 style=\"text-align:center;\">Email: $email</h2>".
     "<h2 style=\"text-align:center;\">Password: $password</h2>".
     "<br>".
     "<h3>Created on: $createdDate".
     "<span style=\"float:right;\">End on: $endDate</span></h3>";
...
while($row = mysqli_fetch_assoc($qry)){
    ...
    echo "
        <tr style=\"color:$color\">
            <td style=\"padding:5px 10px\">".$row['value']."</td>
            <td style=\"padding:5px 10px\">".$row['pin']."</td>
            <td style=\"padding:5px 10px\">".$row['redeemdate']."</td>
            <td style=\"padding:5px 10px\">".$row['endDate']."</td>";
...
echo "<br><a class = \"\" href=\"update-account.php?id=$accountId\">Update Account</a>";
